...
type 'a bouncingball = { mutable init_30 : 'a }

let bouncingball () = { init_30 = (true : bool) }

let bouncingball_step self (z_24, z_22) (lx_19, lv_16) d_1 x0_5 v0_4 start_3 eps_2 =
