...
module Std (Dom : Domain.T) : Analysis.T with type analysisparam_t = std_param_t
...
module Bool : Analysis.T with type analysisparam_t = bool_param_t
...
module Hyb (Dom : Domain.T) : Analysis.T with type analysisparam_t = hyb_param_t
