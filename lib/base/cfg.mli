...
type info_t =
  { mutable locidx : locid_t
  ; mutable arcidx : arcid_t
  }
...
(** adds an arc *)
val add_arc : Env.t -> t -> locid_t -> locid_t -> Arc.t -> arcid_t

(** adds an arc if it is Boolean-feasible *)
val add_arc_if_reach
  :  Env.t
  -> t
  -> locid_t
  -> locid_t
...
(** copies the location with the given location id and replaces 
    its associated data *)
val copy_location_with : Env.t -> t -> locid_t -> Loc.t -> Env.boolexpr_t -> t * locid_t

(** updates the data associated to the given location id *)
val update_location_with : Env.t -> t -> locid_t -> Loc.t -> Env.boolexpr_t -> unit
...
val get_arcs : t -> (Arc.t -> bool) -> (int * Arc.t * int * int) PSette.t

val get_arcs2
  :  t
  -> (Arc.t -> (Env.boolexpr_t * Env.equs_t) option)
  -> (int * Env.boolexpr_t * Env.equs_t * int * int) PSette.t

val get_normal_arcs : t -> (int * Env.boolexpr_t * Env.equs_t * int * int) PSette.t
val get_loop_arcs : t -> (int * Env.boolexpr_t * Env.equs_t * int * int) PSette.t
val get_accel_arcs : t -> (int * Env.boolexpr_t * Env.equs_t * int * int) PSette.t
val get_boolaccel_arcs : t -> (int * Env.boolexpr_t * Env.equs_t * int * int) PSette.t
val get_boolnaccaccel_arcs : t -> (int * Env.boolexpr_t * Env.equs_t * int * int) PSette.t
val get_bool_arcs : t -> (int * Env.boolexpr_t * Env.equs_t * int * int) PSette.t
val get_boolnacc_arcs : t -> (int * Env.boolexpr_t * Env.equs_t * int * int) PSette.t

val get_normal_arcs_in_loc
  :  t
  -> int
  -> (int * Env.boolexpr_t * Env.equs_t * int * int) PSette.t

val get_flow_arcs_in_loc : t -> int -> (int * Env.boolexpr_t * Env.equs_t) PSette.t
...
val arcs_compare2
  :  int * Env.boolexpr_t * Env.equs_t * int * int
  -> int * Env.boolexpr_t * Env.equs_t * int * int
  -> int
