...
val compute_partition_expr_list
  :  Env.t
  -> Env.boolexpr_t
  -> Env.boolexpr_t list
  -> Env.boolexpr_t list
...
val partition_all_by
  :  Env.t
  -> Cfg.t
  -> Cfg.locid_t PSette.t
  -> Env.boolexpr_t
  -> Env.boolexpr_t list
  -> unit

(** partitions the given location by the given partition *)
val partition_disjoint_loc
  :  Env.t
  -> Cfg.t
  -> Env.boolexpr_t
  -> Cfg.locid_t
...
val partition_recsucc
  :  Env.t
  -> Cfg.t
  -> Env.boolexpr_t
  -> (Env.t -> Env.equs_t -> Env.boolexpr_t -> Env.boolexpr_t -> Env.boolexpr_t PSette.t)
  -> Cfg.locid_t PSette.t
  -> unit
