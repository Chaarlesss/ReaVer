...
val make : ('a, 'b) compare -> ('a, 'b, 'c, 'd, 'e) SHGraph.t -> ('a, 'b, 'c, 'd, 'e) t
...
val iter_vertex
  :  ('a, 'b, 'c, 'd, 'e) t
  -> ('a -> 'c -> pred:'b PSette.t -> succ:'b PSette.t -> unit)
  -> unit
...
val fold_hedge
  :  ('a, 'b, 'c, 'd, 'e) t
  -> ('b -> 'd -> pred:'a array -> succ:'a array -> 'f -> 'f)
  -> 'f
  -> 'f
...
val topological_sort : ?priority:'a priority -> ('b, 'a, 'c, 'd, 'e) t -> 'b -> 'b list
...
val reachable_multi
  ...
  -> ('a, 'b, 'c, 'd, 'e) t
  -> 'a PSette.t
  -> 'a PSette.t * 'b PSette.t

val cfc : ?priority:'a priority -> ('b, 'a, 'c, 'd, 'e) t -> 'b -> 'b list list
...
val scfc : ?priority:'a priority -> ('b, 'a, 'c, 'd, 'e) t -> 'b -> (unit, 'b) Ilist.t
