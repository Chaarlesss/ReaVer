...
let make compare set = { compare; set }
...
let union t1 t2 = make t1.compare (Sette.Compare.union t1.compare t1.set t2.set)
let inter t1 t2 = make t1.compare (Sette.Compare.inter t1.compare t1.set t2.set)
let diff t1 t2 = make t1.compare (Sette.Compare.diff t1.compare t1.set t2.set)
let equal t1 t2 = Sette.Compare.equal t1.compare t1.set t2.set
let compare t1 t2 = Sette.Compare.compare t1.compare t1.set t2.set
let subset t1 t2 = Sette.Compare.subset t1.compare t1.set t2.set
let filter f t = make t.compare (Sette.Compare.filter t.compare f t.set)
