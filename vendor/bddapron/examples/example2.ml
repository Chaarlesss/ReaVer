...
let env = Env.add_vars env [ "counter", `Int; "x", `Real; "bcounter", `Bint (false, 3) ]
...
let cst_0 = Expr1.Apron.to_expr (Expr1.Apron.cst env cond (Apron.Coeff.s_of_int 0));;

printf "cst_0 = %a@." (Expr1.print cond) cst_0;;

let cst_2 = Expr1.Apron.to_expr (Expr1.Apron.cst env cond (Apron.Coeff.s_of_int 2));;

printf "cst_2 = %a@." (Expr1.print cond) cst_2;;

let bcst_2 = Expr1.Bint.to_expr (Expr1.Bint.of_int env cond (`Bint (false, 3)) 2);;

printf "bcst_2 = %a@." (Expr1.print cond) bcst_2;;

let bcst_3 = Expr1.Bint.to_expr (Expr1.Bint.of_int env cond (`Bint (false, 3)) 3);;
...
let expr1 =
  Expr1.Apron.ite
    ...
    (Expr1.Apron.add cond (Expr1.Apron.of_expr x) (Expr1.Apron.of_expr cst_2))
;;
