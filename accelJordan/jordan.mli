...
val print_block : (Format.formatter -> 'a -> unit) -> Format.formatter -> 'a block -> unit
...
val block_of_cblock2 : Complex.t block -> Complex.t block -> real block * Matrix.C.t
...
val maps_dim_ij
  :  real t
  -> (coeff, int) DMappe.t
  -> (int, (bool * int * int) list) Mappe.t * (int * int, bool * int) Mappe.t
